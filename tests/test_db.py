...
from fjfnaranjobot.db import DbField, DbRelation, cursor, reset_connection

from .base import MemoryDbTestCase, MockedEnvironTestCase

MODULE_PATH = "fjfnaranjobot.db"


class DbMemoryTests(MockedEnvironTestCase):
...
class DbPathTests(MockedEnvironTestCase):
    def setUp(self):
        super().setUp()
